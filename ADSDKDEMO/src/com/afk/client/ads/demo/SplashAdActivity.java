...
import com.ks.client.ads.SplashAd;
import com.ks.client.ads.inf.SplashAdListener;
...
public class SplashAdActivity extends Activity {
    ...
    String adPlaceId = Ids.SPLASHID; // 重要：请填上您的广告位ID，代码位错误会导致无法请求到广告 debug
    ...
    private void initData() {
        ...
        splashAd = new SplashAd(this, rl_splash_adsParent, listener, adPlaceId, 8, true);
    }
